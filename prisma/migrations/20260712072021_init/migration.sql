-- CreateEnum
CREATE TYPE "Role" AS ENUM ('FleetManager', 'Driver', 'SafetyOfficer', 'FinancialAnalyst', 'Dispatcher');
...
CREATE TABLE "FuelExpenseLog" (
    ...
    CONSTRAINT "FuelExpenseLog_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "FuelExpenseLog" ADD CONSTRAINT "FuelExpenseLog_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "Vehicle"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

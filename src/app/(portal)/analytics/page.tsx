  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm"><p className="text-sm text-slate-500">Maintenance cost KPI</p><p className="mt-2 text-2xl font-semibold">KSh 0</p></div>
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm"><p className="text-sm text-slate-500">Operational cost KPI</p><p className="mt-2 text-2xl font-semibold">KSh {metrics.operationalCost.toLocaleString()}</p></div>
